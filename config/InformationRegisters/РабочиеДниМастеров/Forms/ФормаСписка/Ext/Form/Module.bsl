...
Процедура ОбновитьДанныеПланировщикаСервер()
	...
	|	ДОБАВИТЬКДАТЕ(ЗаписиНаПрием.ДатаВремяЗаписи, МИНУТА, ЗаписиНаПрием.Номекнлатура.Длительность) КАК Конец
	|ИЗ
	|	РегистрСведений.ЗаписиНаПрием КАК ЗаписиНаПрием
	|ГДЕ
	|	ЗаписиНаПрием.Мастер = &Мастер
	...
	Пока Выборка.Следующий() Цикл
		...
		ЭлементПланировщика.Значение.Вставить("Номекнлатура", Выборка.Номекнлатура);
		ЭлементПланировщика.Значение.Вставить("ТипЗаписиНаПрием", Выборка.ТипЗаписиНаПрием);
		ЭлементПланировщика.Текст		= Выборка.Контрагент;
		ЭлементПланировщика.Подсказка	= Выборка.Контрагент;
