...
//
Процедура ДобавитьНоменклатуру(Мастер, Номенклатура, ТипЗаписиНаПрием = Неопределено) Экспорт
	...
	Иначе
		...
		СтрокаТабличнойЧасти.ТипЗаписиНаПрием   = ?(ТипЗаписиНаПрием=Неопределено, Перечисления.ТипыЗаписейНаПрием.Телеграм, ТипЗаписиНаПрием);
	КонецЕсли;
